...
// Link YouTube untuk tutorial
const YOUTUBE_TUTORIAL_LINK =
	"https://www.youtube.com/results?search_query=tutorial+memasak+indonesia";

// ID untuk target scroll
const SCROLL_TARGET_ID = "resep-makanan-section";
...
export default function HeroSection() {
	return (
		<section className="relative overflow-hidden min-h-screen md:min-h-[85vh] flex items-center">
			...
			<div
				className="absolute bottom-32 right-12 w-32 h-32 bg-gradient-to-r from-purple-300/20 to-pink-300/20 rounded-full blur-2xl animate-pulse"
				style={{ animationDelay: "1s" }}
			/>
			<div
				className="absolute top-1/3 right-8 w-24 h-24 bg-gradient-to-r from-cyan-200/30 to-blue-200/30 rounded-full blur-xl animate-pulse"
				style={{ animationDelay: "2.5s" }}
			/>
			<div
				className="absolute bottom-1/4 left-16 w-20 h-20 bg-gradient-to-r from-indigo-200/25 to-blue-200/25 rounded-full blur-2xl animate-pulse"
				style={{ animationDelay: "3s" }}
			/>
			<div
				className="absolute top-1/2 left-1/4 w-16 h-16 bg-gradient-to-r from-blue-300/15 to-purple-300/15 rounded-full blur-2xl animate-pulse"
			...
			<div className="md:hidden relative z-10 w-full px-4 py-8 text-center">
				<div className="mb-4">
					...
					<p className="text-slate-600 text-base mb-4 mt-4">
						Warisan Kuliner Indonesia
					</p>
					<p className="text-slate-500 text-sm max-w-xs mx-auto leading-relaxed">
						Temukan ribuan resep autentik dari seluruh Nusantara. Dari masakan
						tradisional hingga kreasi modern.
					</p>
				</div>
				...
				{/* Action Buttons (Mobile) - Ganti <button> jadi <a> */}
				<div className="flex flex-col space-y-3 max-w-xs mx-auto">
					...
					<a
						href={YOUTUBE_TUTORIAL_LINK}
						target="_blank"
						rel="noopener noreferrer"
						className="bg-white/25 backdrop-blur-xl border border-white/40 text-slate-700 px-6 py-3 rounded-2xl font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2 text-sm"
					>
					...
					<div className="text-center lg:text-left">
						<div className="mb-10">
							...
							<p className="text-lg text-slate-500 max-w-lg leading-relaxed">
								Temukan ribuan resep autentik dari seluruh Nusantara. Dari
								masakan tradisional hingga kreasi modern yang menggugah selera.
							</p>
						</div>

						{/* Action Buttons (Desktop) - Ganti <button> jadi <a> */}
						<div className="flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
							...
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="bg-white/25 backdrop-blur-xl border border-white/40 text-slate-700 px-10 py-5 rounded-2xl font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3 text-lg"
							>
